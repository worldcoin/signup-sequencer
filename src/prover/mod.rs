...
mod test {
    ...
    fn get_default_proof_input() -> InsertionProofInput {
        ...
        let pre_root: U256 = "0x1b7201da72494f1e28717ad1a52eb469f95892f957713533de6175e5da190af2"
            .parse()
            .unwrap();
        let post_root: U256 = "0x7b248024e18c30f6c8a6c63dad3748d72cd13d1197bfd79a1323216d6ac6e99"
            .parse()
            .unwrap();
        let identities: Vec<U256> = vec![
            "0x1".parse().unwrap(),
            "0x2".parse().unwrap(),
            "0x3".parse().unwrap(),
        ];
        ...
        let input_hash: U256 = "0xa2d9c54a0aecf0f2aeb502c4a14ac45209d636986294c5e3168a54a7f143b1d8"
            .parse()
            .unwrap();
    ...
    impl Service {
        pub async fn new(url: String) -> anyhow::Result<Self> {
            let prove = |Json(payload): Json<InsertionProofInput>| async move {
                match payload.post_root.div_rem(U256::from(2)) {
                    (_, y) if y != U256::ZERO => {
