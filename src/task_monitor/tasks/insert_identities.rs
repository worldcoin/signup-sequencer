...
use crate::identity_tree::{Latest, TreeVersion, UnprocessedStatus};
...
async fn insert_identities(
    ...
    let next_leaf = latest_tree_guard.next_leaf();
    ...
    let data = latest_tree_guard.append_many(&filtered_identities);
